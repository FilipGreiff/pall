...
const navigation = [
  { name: 'Förstasidan', href: '/' },
  { name: 'Produkter', href: '/produkter' },
  { name: 'Kontakt', href: '/kontakt' },
  { name: 'Länkar', href: '/lankar' },
  { name: 'Om Företaget', href: '/om-foretaget' },
  { name: 'Köpa/Sälja/Reparera', href: '/kop-salj-rep' },
]
...
export function Navigation({ isMenuOpen, setIsMenuOpen }: NavigationProps) {
  return (
    <>
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="sm:hidden absolute top-16 left-0 w-full bg-white shadow-lg">
